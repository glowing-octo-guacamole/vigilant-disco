...
class SortedPriorityQueue(PriorityQueueBase):  # base class defines _Item
    ...
    def add(self, key, value):
        ...
        for i, item in enumerate(self._data):
            ...
            if newest < item:
                ...
                # Insert the new item at the position (i)
                self._data.insert(i, newest)

                # Break out of the loop after having found the correct position and completed the insertion
                break
        else:

            # Append the new item to the end if no position is found after the loop
    ...
    def min(self):
        ...
        # Return the smallest item at the front of the list
        item = self._data[0]
